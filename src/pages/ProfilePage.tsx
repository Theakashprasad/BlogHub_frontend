...
const ProfilePage: React.FC = () => {
  ...
  const handleBlogUpdate = (updatedBlog: Blog) => {
    setBlogs((prevBlogs) => {
      const existingBlogIndex = prevBlogs.findIndex(
    ...
    >
      <div className="flex-1 flex gap-6 max-w-7xl mx-auto">
        <div className="w-1/3 sticky top-6">
          <button
            onClick={() => navigate(-1)}
            className="text-black hover:text-blue-600 transition-colors duration-300 font-semibold flex items-center py-5"
          >
            ← Back
          </button>
          <div className="bg-white shadow-lg rounded-lg p-6 text-center">
            ...
            <Button
              className="bg-[#7B5C4C] text-white hover:bg-[#4E3B30] transition-colors duration-300 h-10 w-32 rounded-lg"
